...
from .constants import PLCTYPE_BOOL, PLCTYPE_BYTE, PLCTYPE_DATE, PLCTYPE_DINT, \
    ...
    PLCTYPE_SINT, PLCTYPE_STRING, PLCTYPE_TIME, PLCTYPE_TOD, PLCTYPE_UDINT, \
    PLCTYPE_UINT, PLCTYPE_USINT, PLCTYPE_WORD, PLCTYPE_ARR_DINT, \
    PLCTYPE_ARR_INT, PLCTYPE_ARR_LREAL, PLCTYPE_ARR_REAL, PLCTYPE_ARR_SHORT
