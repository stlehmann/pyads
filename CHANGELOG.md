...
- {+ Added: +} [#462](https://github.com/stlehmann/pyads/issues/462) Short description on Linux build dependencies in docs
- CHANGED: [#400](https://github.com/stlehmann/pyads/issues/400) Full support for pyproject.toml
